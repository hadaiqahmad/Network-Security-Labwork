\\add the DESCipherTest.java along with the decryption algorithm
...
public class DESCipherTest {
	...
	DESCipherTest(){
		...
		try {
			...
			byte[] theMsg = getTestMsg(msg);
			byte[] theCph = cipherBlock(theMsg,subKeys,mode);
	...
	public static byte[] cipherBlock(byte[] theMsg, byte[][] subKeys,String mode)
			throws Exception {
		/*....Your Code Here */
		if (theMsg.length<8) 
	...
	/*..Performing Xor Operation with Key & Right side of Bits....*/
	...
	/* Performing Substitution Function (S-Box)*/
	...
	/* Bits Concatenation After 16 rounds */
	...
	/* For Dividing Message after initial permutation in two halves....*/
	...
	// Initial Permutation, Expansion, Round Function Permutation, Inverse Permutation
	...
	/* Hard Coded Key for 16 rounds ..*/

	public static byte[][] getTestSubkeys() {
		String[] strKeys = {
	...
	/* Hard Coded Text Message.... */

	public static byte[] getTestMsg(String msg) {
